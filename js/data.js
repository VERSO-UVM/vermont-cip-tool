...
export const WORKSHEET_DEFS = {
  ...
  facilities: {
    ...
    rows: [
      { id: "fac-town-office",  label: "Town Office / Town Hall", type: "fixed" },
      { id: "fac-town-garage",  label: "Town Garage",        type: "fixed" },
      { id: "fac-town-shed",    label: "Town Shed",          type: "named" },
      { id: "fac-fire-station", label: "Fire Station",       type: "fixed" },
      { id: "fac-library",      label: "Library",            type: "fixed" },
      { id: "fac-school",       label: "School / Community Center", type: "named" },
  ...
  water: {
    ...
    rows: [
      ...
      { id: "ww-pump-1",     label: "Pump Station (1)",    type: "named" },
      { id: "ww-pump-2",     label: "Pump Station (2)",    type: "named" },
  ...
  equipment: {
    ...
    rows: [
      { id: "eq-dump-1",    label: "Dump Truck (1)",   type: "named" },
      { id: "eq-dump-2",    label: "Dump Truck (2)",   type: "named" },
      { id: "eq-dump-3",    label: "Dump Truck (3)",   type: "named" },
      { id: "eq-grader",    label: "Grader",           type: "fixed" },
      { id: "eq-loader",    label: "Loader",           type: "fixed" },
      { id: "eq-backhoe",   label: "Backhoe / Excavator", type: "fixed" },
      { id: "eq-tractor",   label: "Tractor",          type: "named" },
